...
import { Dna, LayoutDashboard, BookOpen, ClipboardList, LogOut, Coffee, TrendingUp, FileText, PenTool, Calculator } from "lucide-react";
...
export default function Navbar() {
  ...
  const links = [
    ...
    { href: "/maths-questions", label: "Maths", icon: Calculator},
    { href: "/essays", label: "Essays", icon: PenTool },
  ];
